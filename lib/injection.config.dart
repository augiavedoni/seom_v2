...
import 'application/vehicles/vehicle_actor/vehicle_actor_bloc.dart' as _i23;
import 'application/vehicles/vehicle_watcher/vehicle_watcher_bloc.dart' as _i24;
...
import 'infrastructure/core/seom_injectable_modules.dart' as _i26;
...
_i1.GetIt $initGetIt(
  ...
  gh.factory<_i18.PaymentMethodActorBloc>(
      () => _i18.PaymentMethodActorBloc(get<_i13.IPaymentMethodRepository>()));
  gh.factory<_i19.PaymentMethodFormBloc>(
      () => _i19.PaymentMethodFormBloc(get<_i13.IPaymentMethodRepository>()));
  gh.factory<_i20.PaymentMethodWatcherBloc>(() =>
      _i20.PaymentMethodWatcherBloc(get<_i13.IPaymentMethodRepository>()));
  gh.factory<_i21.SignInFormBloc>(
      () => _i21.SignInFormBloc(get<_i9.IAuthFacade>()));
  gh.factory<_i22.SignUpFormBloc>(
      () => _i22.SignUpFormBloc(get<_i9.IAuthFacade>()));
  gh.factory<_i23.VehicleActorBloc>(
      () => _i23.VehicleActorBloc(get<_i15.IVehicleRepository>()));
  gh.factory<_i24.VehicleWatcherBloc>(
      () => _i24.VehicleWatcherBloc(get<_i15.IVehicleRepository>()));
  gh.factory<_i25.AuthBloc>(() => _i25.AuthBloc(get<_i9.IAuthFacade>()));
  return get;
}

class _$SeomInjectableModules extends _i26.SeomInjectableModules {}
